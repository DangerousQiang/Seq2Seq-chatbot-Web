...
(function ($) {
  ...
  if ($("#chart-activity").length) {
	    var lineChartCanvas = $("#chart-activity").get(0).getContext("2d");
    var data = {
      labels: ["2/01", "2/02", "2/03", "2/04", "2/5", "2/06", "2/07"],
      datasets: [
        {
          label: 'Support',
          data: [19753, 9749, 5727, 3221, 2762, 2243, 2118],
          borderColor: [
            '#fdbab1'
          ],
          borderWidth: 3,
        ...
        {
          label: 'Product',
          data: [parseInt({{login_num}}), 0, 0, 0, 0, 0, 0],
          borderColor: [
            '#439aff'
          ],
          borderWidth: 3,
